...
Focus of this script is to demonstrates what can be done - not on creating
a Form that makes much sense.
...
widget.field_label = "just some arbitrary text - e.g. to help filling the field"
...
widget.text_font = "TiRo"  # use font Times-Bold
widget.text_fontsize = fontsize  # set fontsize
widget.text_maxlen = 50  # restrict to 40 characters
widget.field_value = "Times-Roman - bold is not supported!"
...
widget.field_label = "doesn't drop down: scroll while cursor in the field"
...
page.insertTextbox(r41, "ComboBox:", align=fitz.TEXT_ALIGN_RIGHT)
widget = fitz.Widget()
...
t1 = mytime() - t0
print("total CPU time %g seconds" % t1)
